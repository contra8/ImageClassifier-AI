...
def create_model(device, structure = 'vgg16', dropout_rate = 0.2, hidden_layer1 = 5000, lr = 0.001, output_layer_size = 102):
    if structure == 'vgg16':
    ...
    classifier = nn.Sequential(OrderedDict([
        ...
        ('fc_2', nn.Linear(hidden_layer1, output_layer_size)),
